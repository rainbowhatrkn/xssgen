...
<head>
    ...
    <style>
        ...
        #particles-js {
            ...
            /* Préfixes vendeurs pour les propriétés spécifiques à la transition et à la transformation */
    ...
    <body>
        <h1 class="animate__animated animate__pulse">Hacker Countdown to Payload Builder</h1>       <div id="particles-js"></div>
            <script src="https://static.trkn.repl.co/particles.js"></script>
            <script src="https://static.trkn.repl.co/particles.json"></script>
            <script src="https://static.trkn.repl.co/app.js"></script>          
        <div class="countdown-container">
            ...
            <div id="challenge-links">
                ...
                <p><a href="https://m.facebook.com/groups/376747741007698/permalink/753956476620154/" target="_blank">Facebook Challenge</a></p></div>
            </div>
        </div>
    </div>
